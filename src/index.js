...
// socket.emit('countUpdated', count)
    ...
    // socket.on('increment', () => {
    //     count++
    //     //socket.emit('countUpdated',count) //this emits event for a specific connection
    // io.emit('countUpdated', count) // emits event for every singleconnection
    // })
...
//create a "dev" script to start the app using nodemon 
